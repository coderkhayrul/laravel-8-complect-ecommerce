            ...
            <div class="blog-page">
                <div class="col-md-9">
                    ...
                    <div class="blog-post  wow fadeInUp">
                        <a href=""><img class="img-responsive" src="{{ asset($item->post_image) }}" alt=""></a>
                        <h1>
                            <a href="{{ route('post.details',$item->id) }}">
                            @if (session()->get('language') == 'hindi') {{ $item->post_title_hin }} @else {{ $item->post_title_en }} @endif
                            </a>
                        </h1>
                        <span class="date-time">{{ Carbon\Carbon::parse($item->created_at)->diffForHumans() }}</span>
                        <p>
                            @if (session()->get('language') == 'hindi') {!! Str::limit($item->post_details_hin, 400) !!} @else {!! Str::limit($item->post_details_en, 400) !!} @endif
                        </p>
