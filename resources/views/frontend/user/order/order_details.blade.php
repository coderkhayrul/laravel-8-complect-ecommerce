    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <hr>
                    <div style="background-color:#E9EBEC" class="card-body">
                        <table class="table">
                            <tr>
                                <th>Shipping Name:</th>
                                <th>{{ $order->name }}</th>
            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <hr>
                    <div style="background-color:#b3d5da" class="card-body">
                        <table class="table">
                            <tr>
                                <th>Name :</th>
       ...
       <form action="{{ route('return.order',$order->id) }}" method="post">
           ...
           <div class="form-group">
               ...
               <textarea class="form-control" name="return_reason" id="" cols="30" rows="5">Return Reason</textarea>
            </div>
            <button type="submit" class="btn btn-danger">Order Return</button>
        </form>
        @else
        <span class="badge badge-pill badge-warning text-center" style="background:red;">You Have Send Return Request For This Product</span>
       @endif
       @endif
       <br><br>
    </div>
