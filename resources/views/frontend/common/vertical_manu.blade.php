        ...
        <ul class="nav">
            ...
            <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle"
                    data-toggle="dropdown"><i class="{{ $category->category_icon }}"
                        aria-hidden="true"></i>@if (session()->get('language') == 'hindi')
                    {{ $category->category_name_hin }} @else {{ $category->category_name_en }}@endif</a>
                <!-- ================================== MEGAMENU VERTICAL ================================== -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-3">
                                ...
                                <h2 class="title">@if (session()->get('language') == 'hindi')
                                    ...
                                    {{ $subcategory->subcategory_name_en }} @endif</h2>
                                </a>
                                @php
