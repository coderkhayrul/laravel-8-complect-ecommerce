...
@section('title')
Sub Sub Category - Easy Online Shop
@endsection
    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                <li class='active'>{{ $item->category->category_name_en }} / {{ $item->subcategory->subcategory_name_en }} / {{ $item->subsubcategory_name_en }}</li>
                @endforeach
                                        ...
                                        <div class="accordion-body collapse" id="collapse{{ $category->id }}"
                                            ...
                                            <div class="accordion-inner">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="{{ url('subcategory/product/'. $subcategory->id.'/'.$subcategory->subcategory_slug_eng) }}">
                                                            @if (session()->get('language') == 'hindi')
                                      ...
                                      <div class="col col-sm-8 col-lg-8">
                                        <div class="product-info">
                                          ...
                                          <div class="description m-t-10">
                                            @if (session()->get('language') == 'hindi')
                                            {{ $product->short_description_hin }} @else
                                            {{ $product->short_description_en }} @endif
                                          </div>
                                          <div class="cart clearfix animate-effect">
                                            <div class="action">
                                              <ul class="list-unstyled">
