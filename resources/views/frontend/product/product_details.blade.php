...
@section('title')
{{ $product->product_name_en }} | Easy Online Shop
@endsection
                        ...
                        <div class='col-sm-6 col-md-7 product-info-block'>
                            <div class="product-info">
                                ...
                                <div class="description-container m-t-20">
                                    @if (session()->get('language') == 'hindi') {{ $product->short_description_hin }}
                                    @else {{ $product->short_description_en }} @endif
                                ...
                                <div id="description" class="tab-pane in active">
                                    <div class="product-tab">
                                        <p class="text">
                                            ...
                                            @else {!! $product->long_description_en !!} @endif
                                        </p>
                                    </div>
                                </div><!-- /.tab-pane -->
                                    ...
                                    <div class="product-tab">
                                        ...
                                        <div class="product-reviews">
                                            ...
                                            <div class="reviews">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <img  style="border-radius: 50%" src="{{ (!empty($review->user->profile_photo_path)) ? url('upload/user_images/'.$review->user->profile_photo_path)
                                                        : url('upload/no_image.jpg') }}" width="40px" height="40px" alt=""> <b>{{ $review->user->name }}</b>
                                                    </div>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="review">
                                                    <div class="review-title"><span class="summary">{{ $review->summary }}</span><span class="date"><i
                                                                class="fa fa-calendar"></i><span>{{ Carbon\Carbon::parse($review->created_at)->diffForHumans() }}</span></span> </span></span></div>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control txt"
                                                                        id="summary" name="summary" placeholder="">
                                                                </div><!-- /.form-group -->
                                                            </div>
