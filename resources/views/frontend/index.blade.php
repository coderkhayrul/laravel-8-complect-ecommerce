        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                    ...
                    <!-- ================================== TOP NAVIGATION ================================== -->
                    @include('frontend.common.vertical_manu')
                    <!-- /.side-menu -->
                    <!-- ================================== TOP NAVIGATION : END ================================== -->
                            ...
                            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                                <li class="active">
                                    <a data-transition-type="backSlide" href="#all" data-toggle="tab">
                                        @if (session()->get('language') == 'hindi') All
                                        @else All @endif
                                    </a>
                                </li>
                                                        ...
                                                        <div class="cart clearfix animate-effect">
                                                            <div class="action">
                                                                <ul class="list-unstyled">
                                                                    ...
                                                                    <button class="btn btn-primary icon" type="button"
                                                                        title="Add Wishlist" id="{{ $product->id }}"
                            ...
                            @foreach ($categories as $category)
                                <div class="tab-pane" id="category{{ $category->id }}">
                                    <div class="product-slider">
                                        <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                            @php
                                                $catproduct = App\Models\Product::where('category_id', $category->id)
                                                    ->limit(6)
                                                    ->get();
                                            @endphp
                                            ...
                                            @endforelse($catproduct as $product)
                                        </div>
                                        <!-- /.home-owl-carousel -->
                                    </div>
                                    <!-- /.product-slider -->
                                        ...
                                        <div class="blog-post">
                                            <div class="blog-post-image">
                                                <div class="image"> <a href="blog.html"><img
                                                            src="{{ asset($blogPost->post_image) }}" alt=""></a> </div>
                                            </div>
                                            <!-- /.blog-post-image -->

                                            <div class="blog-post-info text-left">
                                                <h3 class="name"><a href="{{ route('post.details', $blogPost->id) }}">
                                                        @if (session()->get('language') == 'hindi')
                                                        {{ $blogPost->post_title_hin }} @else
                                                            {{ $blogPost->post_title_en }} @endif
                                                    </a></h3>
                                                <span class="info">&nbsp;
                                                ...
                                                <p class="text">
                                                    @if (session()->get('language') == 'hindi')
                                                    {!! Str::limit($blogPost->post_details_hin, 100) !!} @else {!! Str::limit($blogPost->post_details_en, 100) !!} @endif
                                                </p>
                                                <a href="{{ route('post.details', $blogPost->id) }}"
